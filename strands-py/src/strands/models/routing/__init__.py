...
and no hook has claimed the retry, the router advances to the next untried candidate; fallback is
cyclic, so a successful call makes the other candidates eligible again. The API is provisional and may
